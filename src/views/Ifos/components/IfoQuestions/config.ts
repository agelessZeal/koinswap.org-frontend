...
const config = (t: ContextApi['t']) => {
  return [
    ...
    },
    {
      ...
      description: [
        t(
          'You can choose one or both at the same time! If you’re only committing a small amount, we recommend the Basic Sale first. Just remember you need a koinswAp Profile in order to participate.',
        ),
      ],
    },
    {
